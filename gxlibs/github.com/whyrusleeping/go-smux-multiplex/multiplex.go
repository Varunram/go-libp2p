...
import (
	...
	mp "github.com/libp2p/go-libp2p/gxlibs/github.com/whyrusleeping/go-multiplex" // Conn is a connection to a remote peer.
	smux "github.com/libp2p/go-libp2p/gxlibs/github.com/libp2p/go-stream-muxer"
)
